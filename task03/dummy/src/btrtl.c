...
#define IC_INFO(lmps, hcir, hciv, bus)                      \
  ...
  .lmp_subver = (lmps), .hci_rev = (hcir), .hci_ver = (hciv), .hci_bus = (bus)

#define RTL_CHIP_SUBVER \
  (&(struct rtl_vendor_cmd){{0x10, 0x38, 0x04, 0x28, 0x80}})
...
static const struct id_table ic_id_table[] = {
    /* 8723A */
    {IC_INFO(RTL_ROM_LMP_8723A, 0xb, 0x6, HCI_USB), .config_needed = false,
     .has_rom_version = false, .fw_name = "rtl_bt/rtl8723a_fw",
     .cfg_name = NULL, .hw_info = "rtl8723au"},

    /* 8723BS */
    {IC_INFO(RTL_ROM_LMP_8723B, 0xb, 0x6, HCI_UART), .config_needed = true,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8723bs_fw",
     .cfg_name = "rtl_bt/rtl8723bs_config", .hw_info = "rtl8723bs"},

    /* 8723B */
    {IC_INFO(RTL_ROM_LMP_8723B, 0xb, 0x6, HCI_USB), .config_needed = false,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8723b_fw",
     .cfg_name = "rtl_bt/rtl8723b_config", .hw_info = "rtl8723bu"},

    /* 8723CS-CG */
    {.match_flags =
         IC_MATCH_FL_LMPSUBV | IC_MATCH_FL_CHIP_TYPE | IC_MATCH_FL_HCIBUS,
    ...
    /* 8723D */
    {IC_INFO(RTL_ROM_LMP_8723B, 0xd, 0x8, HCI_USB), .config_needed = true,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8723d_fw",
     .cfg_name = "rtl_bt/rtl8723d_config", .hw_info = "rtl8723du"},

    /* 8723DS */
    {IC_INFO(RTL_ROM_LMP_8723B, 0xd, 0x8, HCI_UART), .config_needed = true,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8723ds_fw",
     .cfg_name = "rtl_bt/rtl8723ds_config", .hw_info = "rtl8723ds"},

    /* 8821A */
    {IC_INFO(RTL_ROM_LMP_8821A, 0xa, 0x6, HCI_USB), .config_needed = false,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8821a_fw",
     .cfg_name = "rtl_bt/rtl8821a_config", .hw_info = "rtl8821au"},

    /* 8821C */
    {IC_INFO(RTL_ROM_LMP_8821A, 0xc, 0x8, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8821c_fw", .cfg_name = "rtl_bt/rtl8821c_config",
     .hw_info = "rtl8821cu"},

    /* 8821CS */
    {IC_INFO(RTL_ROM_LMP_8821A, 0xc, 0x8, HCI_UART), .config_needed = true,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8821cs_fw", .cfg_name = "rtl_bt/rtl8821cs_config",
     .hw_info = "rtl8821cs"},

    /* 8761A */
    {IC_INFO(RTL_ROM_LMP_8761A, 0xa, 0x6, HCI_USB), .config_needed = false,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8761a_fw",
     .cfg_name = "rtl_bt/rtl8761a_config", .hw_info = "rtl8761au"},

    /* 8761B */
    {IC_INFO(RTL_ROM_LMP_8761A, 0xb, 0xa, HCI_UART), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8761b_fw", .cfg_name = "rtl_bt/rtl8761b_config",
     .hw_info = "rtl8761btv"},

    /* 8761BU */
    {IC_INFO(RTL_ROM_LMP_8761A, 0xb, 0xa, HCI_USB), .config_needed = false,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8761bu_fw",
     .cfg_name = "rtl_bt/rtl8761bu_config", .hw_info = "rtl8761bu"},

    /* 8761CU */
    {IC_INFO(RTL_ROM_LMP_8761A, 0x0e, 0, HCI_USB), .config_needed = false,
     .has_rom_version = true, .fw_name = "rtl_bt/rtl8761cu_fw",
     .cfg_name = "rtl_bt/rtl8761cu_config", .hw_info = "rtl8761cu"},

    /* 8822C with UART interface */
    {IC_INFO(RTL_ROM_LMP_8822B, 0xc, 0x8, HCI_UART), .config_needed = true,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8822cs_fw", .cfg_name = "rtl_bt/rtl8822cs_config",
     .hw_info = "rtl8822cs"},

    /* 8822C with UART interface */
    {IC_INFO(RTL_ROM_LMP_8822B, 0xc, 0xa, HCI_UART), .config_needed = true,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8822cs_fw", .cfg_name = "rtl_bt/rtl8822cs_config",
     .hw_info = "rtl8822cs"},

    /* 8822C with USB interface */
    {IC_INFO(RTL_ROM_LMP_8822B, 0xc, 0xa, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8822cu_fw", .cfg_name = "rtl_bt/rtl8822cu_config",
     .hw_info = "rtl8822cu"},

    /* 8822B */
    {IC_INFO(RTL_ROM_LMP_8822B, 0xb, 0x7, HCI_USB), .config_needed = true,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8822b_fw", .cfg_name = "rtl_bt/rtl8822b_config",
     .hw_info = "rtl8822bu"},

    /* 8852A */
    {IC_INFO(RTL_ROM_LMP_8852A, 0xa, 0xb, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8852au_fw", .cfg_name = "rtl_bt/rtl8852au_config",
     .hw_info = "rtl8852au"},

    /* 8852B with UART interface */
    {IC_INFO(RTL_ROM_LMP_8852A, 0xb, 0xb, HCI_UART), .config_needed = true,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8852bs_fw", .cfg_name = "rtl_bt/rtl8852bs_config",
     .hw_info = "rtl8852bs"},

    /* 8852B */
    {IC_INFO(RTL_ROM_LMP_8852A, 0xb, 0xb, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8852bu_fw", .cfg_name = "rtl_bt/rtl8852bu_config",
     .hw_info = "rtl8852bu"},

    /* 8852C */
    {IC_INFO(RTL_ROM_LMP_8852A, 0xc, 0xc, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8852cu_fw", .cfg_name = "rtl_bt/rtl8852cu_config",
     .hw_info = "rtl8852cu"},

    /* 8851B */
    {IC_INFO(RTL_ROM_LMP_8851B, 0xb, 0xc, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = false,
     .fw_name = "rtl_bt/rtl8851bu_fw", .cfg_name = "rtl_bt/rtl8851bu_config",
     .hw_info = "rtl8851bu"},

    /* 8922A */
    {IC_INFO(RTL_ROM_LMP_8922A, 0xa, 0xc, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8922au_fw", .cfg_name = "rtl_bt/rtl8922au_config",
     .hw_info = "rtl8922au"},

    /* 8852BT/8852BE-VT */
    {IC_INFO(RTL_ROM_LMP_8852A, 0x87, 0xc, HCI_USB), .config_needed = false,
     .has_rom_version = true, .has_msft_ext = true,
     .fw_name = "rtl_bt/rtl8852btu_fw", .cfg_name = "rtl_bt/rtl8852btu_config",
     .hw_info = "rtl8852btu"},
};

static const struct id_table* btrtl_match_ic(u16 lmp_subver,
                                             u16 hci_rev,
                                             u8 hci_ver,
                                             u8 hci_bus,
                                             u8 chip_type) {
  ...
  for (i = 0; i < ARRAY_SIZE(ic_id_table); i++) {
    ...
    if ((ic_id_table[i].match_flags & IC_MATCH_FL_HCIVER) &&
        (ic_id_table[i].hci_ver != hci_ver) && (ic_id_table[i].hci_ver != 0))
      continue;
...
static struct sk_buff* btrtl_read_local_version(struct hci_dev* hdev) {
  ...
  skb = __hci_cmd_sync(hdev, HCI_OP_READ_LOCAL_VERSION, 0, NULL,
                       HCI_INIT_TIMEOUT);
  if (IS_ERR(skb)) {
    rtl_dev_err(hdev, "HCI_OP_READ_LOCAL_VERSION failed (%ld)", PTR_ERR(skb));
    return skb;
  }
...
static int rtl_read_rom_version(struct hci_dev* hdev, u8* version) {
  ...
  if (IS_ERR(skb)) {
    rtl_dev_err(hdev, "Read ROM version failed (%ld)", PTR_ERR(skb));
    return PTR_ERR(skb);
  }
  ...
  rtl_dev_info(hdev, "rom_version status=%x version=%x", rom_version->status,
               rom_version->version);
...
static int btrtl_vendor_read_reg16(struct hci_dev* hdev,
                                   struct rtl_vendor_cmd* cmd,
                                   u8* rp) {
  struct sk_buff* skb;
  int err = 0;

  skb = __hci_cmd_sync(hdev, 0xfc61, sizeof(*cmd), cmd, HCI_INIT_TIMEOUT);
  if (IS_ERR(skb)) {
    err = PTR_ERR(skb);
...
static int btrtl_parse_section(struct hci_dev* hdev,
  ...
  for (i = 0; i < num_subsecs; i++) {
    ...
    rtl_dev_dbg(hdev, "subsec, eco 0x%02x, len %08x", common_subsec->eco,
                subsec_len);
...
static int rtlbt_parse_firmware_v2(struct hci_dev* hdev,
  ...
  for (i = 0; i < num_sections; i++) {
    ...
    switch (opcode) {
      case RTL_PATCH_SNIPPETS:
        rc = btrtl_parse_section(hdev, btrtl_dev, opcode, ptr, section_len);
        break;
      case RTL_PATCH_SECURITY_HEADER:
    ...
    if (rc < 0) {
      rtl_dev_err(hdev, "RTL: Parse section (%u) err %d", opcode, rc);
      return rc;
    }
    len += rc;
  }
  ...
  list_for_each_entry_safe(entry, tmp, &btrtl_dev->patch_subsecs, list) {
    rtl_dev_dbg(hdev, "RTL: opcode %08x, addr %p, len 0x%x", entry->opcode,
...
static int rtlbt_parse_firmware(struct hci_dev* hdev,
  ...
  static const struct {
    ...
    __u8 id;
      ...
      {RTL_ROM_LMP_8723A, 0},  {RTL_ROM_LMP_8723B, 1}, {RTL_ROM_LMP_8821A, 2},
      {RTL_ROM_LMP_8761A, 3},  {RTL_ROM_LMP_8703B, 7}, {RTL_ROM_LMP_8822B, 8},
  ...
  if (!memcmp(btrtl_dev->fw_data, RTL_EPATCH_SIGNATURE, 8))
    ...
    min_size = sizeof(struct rtl_epatch_header_v2) + sizeof(extension_sig) + 3;
  else
    return -EINVAL;
  ...
  BT_DBG("fw_version=%x, num_patches=%d", le32_to_cpu(epatch_info->fw_version),
         num_patches);
  ...
  for (i = 0; i < num_patches; i++) {
    ...
    if (chip_id == btrtl_dev->rom_version + 1) {
      patch_length = get_unaligned_le16(patch_length_base + (i * sizeof(u16)));
      patch_offset = get_unaligned_le32(patch_offset_base + (i * sizeof(u32)));
      break;
    }
  }
...
static int rtl_download_firmware(struct hci_dev* hdev,
  ...
  for (i = 0; i < frag_num; i++) {
    ...
    rtl_dev_dbg(hdev, "download fw (%d/%d). index = %d", i, frag_num,
                dl_cmd->index);
    memcpy(dl_cmd->data, data, frag_len);

    /* Send download command */
    skb = __hci_cmd_sync(hdev, 0xfc20, frag_len + 1, dl_cmd, HCI_INIT_TIMEOUT);
    if (IS_ERR(skb)) {
      rtl_dev_err(hdev, "download fw command failed (%ld)", PTR_ERR(skb));
      ret = PTR_ERR(skb);
      goto out;
    }
  ...
  rtl_dev_info(hdev, "fw version 0x%04x%04x", __le16_to_cpu(rp->hci_rev),
               __le16_to_cpu(rp->lmp_subver));
  kfree_skb(skb);
...
static int btrtl_setup_rtl8723a(struct hci_dev* hdev,
  ...
  return rtl_download_firmware(hdev, btrtl_dev->fw_data, btrtl_dev->fw_len);
}
...
static int rtl_read_chip_type(struct hci_dev* hdev, u8* type) {
  ...
  if (IS_ERR(skb)) {
    rtl_dev_err(hdev, "Read chip type failed (%ld)", PTR_ERR(skb));
    return PTR_ERR(skb);
  }
  ...
  rtl_dev_info(hdev, "chip_type status=%x type=%x", chip_type->status,
               chip_type->type);
...
check_version:
  ...
  if (lmp_subver == RTL_ROM_LMP_8822B) {
    ...
    if (hci_rev == 0x000e) {
      ...
      lmp_ver = 0x0c;
      btrtl_dev->ic_info =
          btrtl_match_ic(lmp_subver, hci_rev, hci_ver, hdev->bus, chip_type);
      goto next;
    }
  }
...
next:
  rtl_dev_info(
      hdev, "examining hci_ver=%02x hci_rev=%04x lmp_ver=%02x lmp_subver=%04x",
  ...
  if (btrtl_dev->fw_len < 0) {
    snprintf(fw_name, sizeof(fw_name), "%s.bin", btrtl_dev->ic_info->fw_name);
    btrtl_dev->fw_len = rtl_load_file(hdev, fw_name, &btrtl_dev->fw_data);
  }
  ...
  if (btrtl_dev->ic_info->cfg_name && !btrtl_dev->key_id) {
    ...
    btrtl_dev->cfg_len = rtl_load_file(hdev, cfg_name, &btrtl_dev->cfg_data);
...
int btrtl_setup_realtek(struct hci_dev* hdev) {
  ...
  if (btrtl_dev->ic_info) {
    hci_set_hw_info(hdev, "RTL lmp_subver=%u hci_rev=%u hci_ver=%u hci_bus=%u",
                    btrtl_dev->ic_info->lmp_subver, btrtl_dev->ic_info->hci_rev,
                    btrtl_dev->ic_info->hci_ver, btrtl_dev->ic_info->hci_bus);
  }
  ...
  for (i = 0; i < total_data_len;) {
    ...
    switch (le16_to_cpu(entry->offset)) {
      case 0xc:
        ...
        *controller_baudrate = btrtl_convert_baudrate(*device_baudrate);
